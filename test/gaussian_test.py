...
def test_fast_gaussian_logfile_parser():
    ...
    assert job_1["xyz"][0] == [[1.0, 1.0, 0.0, -0.685827, 1.281098, 0.993117],
    ...
    assert job_2["xyz"][1] == [[1.0, 1.0, 0.0, -0.026543, 1.559817, -0.795496],
    ...
    assert job_3["xyz"][-1] == [[1.0, 1.0, 0.0, 0.261758, 1.177112, -0.548527],
